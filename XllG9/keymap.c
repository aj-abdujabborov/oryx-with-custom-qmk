...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [6] = LAYOUT_voyager(
    ...
    KC_NO,          MO(7),          OSM(MOD_LALT),  OSM(MOD_LGUI),  OSM(MOD_LSFT),  KC_NO,                                          LGUI(LCTL(KC_SPACE)),KC_LEFT,        KC_DOWN,        KC_RIGHT,       KC_RIGHT_GUI,   KC_NO,          
    KC_NO,          OSM(MOD_LCTL),  KC_TAB,         KC_F11,         KC_GRAVE,       KC_NO,                                          KC_CAPS,        KC_BSPC,        KC_NO,          LSFT(KC_TAB),   LALT(LGUI(LCTL(LSFT(KC_U)))),KC_NO,          
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [7] = LAYOUT_voyager(
    KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          
    KC_NO,          KC_NO,          ST_MACRO_0,     KC_UP,          KC_NO,          KC_TAB,                                         KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    if (record->event.pressed) {
      SEND_STRING(SS_LGUI(SS_TAP(X_C))SS_DELAY(30)  SS_LGUI(SS_TAP(X_T))SS_DELAY(30)  SS_LGUI(SS_TAP(X_V))  SS_DELAY(30) SS_TAP(X_ENTER));
    }
    break;
    case MAC_SIRI:
      HCS(0xCF);
